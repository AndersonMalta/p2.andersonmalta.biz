...
# What is the name of this app?
	define('APP_NAME', 'Tattler');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'andersonmaltadasilva@fas.harvard.edu'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'andersonmaltadasilva@fas.harvard.edu'); 

# Default DB name for this app
	define('DB_NAME', 'anderso6_p2_andersonmalta_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'fdghhgfh6ytjt6sfg6tjdtfgyjugg');
	define('TOKEN_SALT', '67hkhgbfhdhhk8lhmgnf');